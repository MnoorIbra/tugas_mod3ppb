...
import 'package:tugasmod3_kel09/screens/kelompok.dart';
import 'dart:convert';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
          children: [
            SizedBox(height: 10),
            Text('Top Manga of All Time',style: 
            TextStyle(
              fontSize: 18,
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              onTap: () => 
                              Navigator.push(
                                  context, //buat bikin detail(widget)
                                  MaterialPageRoute(
            ...
            Text('Top Anime of All Time',style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.bold
            ),),
            SizedBox(height: 20,),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Card(
                            child: ListTile(
                              ...
                              subtitle: Text('MAL Score: ${snapshot.data![index].score}'),
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(//buat bikin detail (widget)
                                    builder: (context) => DetailPage(
                                        item: snapshot.data![index].malId,
                                        title: snapshot.data![index].title,
                                        score: snapshot.data![index].score,
